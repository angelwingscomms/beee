...
<style>
  ...
  .dashboard-top { display: flex; justify-content: space-between; gap: 16px; border-bottom: 1px solid var(--line); padding-bottom: 18px; }
  .dashboard-top span { color: var(--muted-dark); }
  .dashboard-top strong { color: var(--gold); }
