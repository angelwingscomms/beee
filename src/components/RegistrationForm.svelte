...
<main class="page-shell simple-home" aria-labelledby="event-title">
  ...
  <span class="text-[20px] font-['Montserrat'] mb-4"><span style="color:var(--ink)">Be</span> <span style="color:var(--primary)">Everything</span> <span style="color:var(--ink)">E✔cellent</span> <span style="color:var(--primary)">Everyday</span></span>
