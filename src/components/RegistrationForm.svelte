...
<main class="page-shell simple-home" aria-labelledby="event-title">
	<section class="container simple-home-grid">
		<div class="event-intro">
			...
			<p class="lead">
				Qualifying participants will advance to the <span class="teamup-font">T.E.A.M.U.P.</span> TEAMUP Development Stage and the Championship Grand Finale in October 2026.
			</p>
			<div
