	...
	<div class="modal-card" role="dialog" aria-modal="true" aria-labelledby="confirm-title">
		...
		<div class="modal-body">
			...
			<div class="modal-total">
				<div>
					<p>Register now</p>
					<p class="summary-item-desc">₦12,500 per player<br><span class="text-[14px] font-bold !text-black" style="font-family:var(--font-display)">Total: ₦50,000 per school team</span></p>
				</div>
