...
export const POST: RequestHandler = async ({ request }) => {
	try {
		...
		const emailContent = {
			to: data.to,
			subject: `BEEE Spectacular Chess Championship Abuja 2026 - Registration Confirmation #${data.registrationId}`,
...
<body>
  <div class="container">
    <div class="header">
      <h1>BEEE Spectacular Chess Championship Abuja 2026</h1>
      <p>registration confirmation</p>
    </div>
    <div class="content">
      <div class="section">
        <h2>welcome to BEEE</h2>
        <p>thank you for registering for the BEEE Spectacular Chess Championship Abuja 2026. your registration has been successfully processed.</p>
      </div>
      ...
      <div class="footer">
        <p>&copy; 2026 BEEE Spectacular Chess Championship. all rights reserved.</p>
