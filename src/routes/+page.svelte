...
<section id="diff-section" class="py-32 md:py-48 bg-navy">
  <div class="max-w-7xl mx-auto px-6">
    ...
    <div bind:this={diffCardsParent} class="grid grid-cols-12 gap-6 auto-rows-[minmax(280px,auto)]">
      ...
      <PlatformCard bg="#7ec8e3" title="TASKIFY&trade;" body="The Taskify Development Passport is a digital record that tracks participant progress, milestones, achievements, badges, certificates, and developmental growth throughout the championship journey." href="/taskify" />
    </div>
