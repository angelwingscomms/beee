...
import { D_TRAINING_WINDOW, D_FINALE } from '$lib/constants';
  ...
  <div class="container">
    ...
    <div class="card">
      ...
      <ol class="steps">
        ...
        <li>October 2026, live preliminary rounds and the Elite Qualifiers Stage at centres across Abuja. Fixtures come by email and WhatsApp.</li>
