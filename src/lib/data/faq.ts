...
export const cs: FaqC[] = [
	{
		i: 'general', n: 'General', qs: [
			...
			{ q: 'What are the championship dates?', a: 'Online coaching runs from August 1 to September 19, with live preliminary competitions in September and the Championship Grand Finale in October 2026.' },
