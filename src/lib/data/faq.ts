...
export const cs: FaqC[] = [
	...
	},
	{
		i: 'teamup', n: 'TEAMUP', qs: [
			...
			{ q: 'Is participation in TEAMUP compulsory?', a: 'Participation is strongly encouraged as it forms an important part of the championship experience.' },
		]
	},
	{
		i: 'passport', n: 'Passport', qs: [
			{ q: 'What is the TEAMUP Development Passport?', a: 'The Development Passport is a digital record of a participant\'s developmental journey throughout the championship cycle.' },
			...
			{ q: 'How do registered players access the programme materials?', a: 'Registered players are issued a Passport code with access to the TEAMUP Development materials.' },
		]
	},
	{
	...
	},
	{
		i: 'awards', n: 'Awards', qs: [
			{ q: 'What are the prizes?', a: 'Prizes may include championship trophies, medals, certificates, achievement awards, TEAMUP Excellence Awards, leadership recognition awards, innovation awards, and special merit awards.' },
	...
	},
	{
		i: 'parents', n: 'Parents & Schools', qs: [
			...
			{ q: 'How will progress be tracked?', a: 'Progress is tracked through the participant\'s TEAMUP Development Passport, which records attendance, milestones, badges, assessment results, and other achievements.' },
			{ q: 'Why should my school partner with BEEE?', a: 'Affiliate schools may complement their summer activities with the TEAMUP programme and benefit from its developmental opportunities.' },
